...
def homeScreen():
    ...
    font=pygame.font.Font("assets/fonts/ARCADECLASSIC.ttf", 150)
    text=font.pygame.font.render(f"Space Shooter", True, WHITE)

    font_2=pygame.font.SysFont(None, 10)
    text_2=font_2.pygame.font.render(f"Press SPACE to Start Game", True, WHITE)
...
def gameOver():
    ...
    text=font.pygame.font.render(f"Game Over", True, BLACK)
